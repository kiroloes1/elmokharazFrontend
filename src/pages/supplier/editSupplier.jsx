  ...
  useEffect(() => {
    const fetchSupplier = async () => {
      try {
        ...
        showAlert({ title: "فشل في تحميل بيانات التاجر", icon: "error" });
      } finally {
        setFetching(false);
      }
    };
        ...
        <div className="bg-dark p-8 text-white relative overflow-hidden">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-black">تعديل بيانات التاجر</h3>
                <p className="text-xs text-slate-400 font-bold uppercase tracking-[2px] mt-1">
                  تعديل البيانات الخاصه بالتاجر 
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-3">
              <label className="text-sm font-black text-dark flex items-center gap-2 mr-1">
                <User size={18} className="text-accent" /> اسم التاجر الكامل
              </label>
              <input
                type="text"
                value={form.name}
